...
export const createPostSchema = moodSchema.omit({ id: true, userID: true, createdAt: true });
export const updatePostSchema = moodSchema.partial().omit({ id: true, createdAt: true, userID: true });
