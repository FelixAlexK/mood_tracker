  ...
  <div class="max-w-3xl mx-auto">
    ...
    <WrapperCardComponent>
      ...
      <div v-else>
        ...
        <MoodFormComponent v-if="isEditing" cancellable :mood="data.data ?? undefined" class="shadow-none hover:shadow-none w-full" @submit="saveChanges" @cancel="cancelEditing" />
      </div>
    </wrappercardcomponent>
